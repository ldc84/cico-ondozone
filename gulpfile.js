...
gulp.task('copy:image', function () {
  return gulp.src(path.source.image + '/**/*.{jpg,png,gif,svg,mp4}')
...
//   runSequence('clean', 'copy:image', 'copy:fonts', 'convert:sass', 'copy:conf', 'html', ['copy:js', 'copy:node_modules'], 'ftp');
// });